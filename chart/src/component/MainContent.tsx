...
const MainContent: React.FC = () => {
  return (
    <div className="flex-1 container mx-auto flex flex-wrap -mx-2">
      {/* Your existing content goes here, e.g., */}
      ...
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">All Contract</h2>
        <ContractCountBarChart
          data={dataAllCountractCount}
      ...
      <div className="w-1/2 p-2">
        ...
        <ContractCountBarChart
          data={dataMonthlyActivityContractCount}
          label="Number of Contracts"
        />
      </div>
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">NFT Count</h2>
        <ContractCountBarChart
          data={dataStatisticsNFTCount}
          label="Number of NFT"
        />
      </div>
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">Owner Count</h2>
        <ContractCountBarChart
          data={dataStatisticsOwnerCount}
          label="Number of owners"
        />
      </div>
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">Threshold</h2>
        <ContractCountBarChart
          data={dataStatisticsThresholdPercentage}
          label="Threshold"
        />
      </div>
      <div className="w-1/2 p-2">
        ...
        <ContractCountBarChart
          data={dataStatisticsThresholdPercentageSans1Of1}
          label="Threshold without 1-of-1"
        />
      </div>
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">
        ...
        <ContractCountBarChart
          data={dataStatisticsThresholdPercentageWith1OfM}
          label="Threshold with 1-of-m"
        />
      </div>
      <div className="w-1/2 p-2">
        <h2 className="text-lg font-bold text-center mb-2">
        ...
        <ContractCountBarChart
          data={dataStatisticsThresholdPercentageWith1OfMSans1Of1}
          label="Threshold with 1-of-m, but without 1-of-1"
        />
      </div>
    </div>
  );
